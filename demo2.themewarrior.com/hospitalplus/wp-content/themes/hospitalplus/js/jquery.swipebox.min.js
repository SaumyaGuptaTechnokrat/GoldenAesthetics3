/*! Swipebox v1.4.4 | Constantin Saguin csag.co | MIT License | github.com/brutaldesign/swipebox */ ! function(e, t, i, s) {
    i.swipebox = function(o, n) {
        ...
        d.settings = {}, i.swipebox.close = function() {
            ...
            d.settings = i.extend({}, l, n), i.isArray(o) ? (p = o, a.target = i(e), a.init(d.settings.initialIndexOnArray)) : i(o).on("click", d.settings.selector, function(e) {
                if ("slide current" === e.target.parentNode.className) return !1;
                var t, s, n;
                a.destroy(), r = null === d.settings.selector ? i(o) : i(o).find(d.settings.selector), p = [], n || (s = "data-rel", n = i(this).attr(s)), n || (s = "rel", n = i(this).attr(s)), n && "" !== n && "nofollow" !== n && (r = r.filter("[" + s + '="' + n + '"]')), r.each(function() {
                    var e = null,
                        t = null;
            ...
            build: function() {
                ...
                i("body").append('<div id="swipebox-overlay">\t\t\t\t\t<div id="swipebox-container">\t\t\t\t\t\t<div id="swipebox-slider"></div>\t\t\t\t\t\t<div id="swipebox-top-bar">\t\t\t\t\t\t\t<div id="swipebox-title"></div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div id="swipebox-bottom-bar">\t\t\t\t\t\t\t<div id="swipebox-arrows">\t\t\t\t\t\t\t\t<a id="swipebox-prev"></a>\t\t\t\t\t\t\t\t<a id="swipebox-next"></a>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<a id="swipebox-close"></a>\t\t\t\t\t</div>\t\t\t</div>'), u && !0 === d.settings.useSVG && (e = (e = i("#swipebox-close").css("background-image")).replace("png", "svg"), i("#swipebox-prev, #swipebox-next, #swipebox-close").css({
                    "background-image": e
                })), c && d.settings.removeBarsOnMobile && i("#swipebox-bottom-bar, #swipebox-top-bar").remove(), i.each(p, function() {
            ...
            gesture: function() {
                ...
                u.addClass("visible-bars"), r.setTimeout(), i("body").bind("touchstart", function(r) {
                    return i(this).addClass("touching"), e = i("#swipebox-slider .slide").index(i("#swipebox-slider .slide.current")), b = r.originalEvent.targetTouches[0], c.pageX = r.originalEvent.targetTouches[0].pageX, c.pageY = r.originalEvent.targetTouches[0].pageY, i("#swipebox-slider").css({
                        ...
                        o = t, t = b.pageX - c.pageX, a = 100 * t / h, !d && !l && Math.abs(t) >= 10 && (i("#swipebox-slider").css({
                            "-webkit-transition": "",
                            transition: ""
                            ...
                            "-webkit-transform": "translate3d(" + (f + a) + "%, 0, 0)",
                            transform: "translate3d(" + (f + a) + "%, 0, 0)"
                    ...
                    if (e.preventDefault(), e.stopPropagation(), i("#swipebox-slider").css({
                        ...
                        }), s = b.pageY - c.pageY, t = b.pageX - c.pageX, a = 100 * t / h, l)
            ...
            setSlide: function(e, t) {
                ...
                f = 100 * -e, this.doCssTrans() ? s.css({
                    ...
                    left: 100 * -e + "%"
                }), i("#swipebox-slider .slide").removeClass("current"), i("#swipebox-slider .slide").eq(e).addClass("current"), this.setTitle(e), t && s.fadeIn(), i("#swipebox-prev, #swipebox-next").removeClass("disabled"), 0 === e ? i("#swipebox-prev").addClass("disabled") : e === p.length - 1 && !0 !== d.settings.loopAtEnd && i("#swipebox-next").addClass("disabled")
            },
            ...
            openMedia: function(e) {
                ...
                o = i("#swipebox-slider .slide").eq(e), this.isVideo(t) ? (o.html(this.getVideo(t)), d.settings.afterMedia && d.settings.afterMedia(e)) : (o.addClass("slide-loading"), this.loadMedia(t, function() {
            ...
            getNext: function() {
                ...
                s + 1 < p.length ? (e = i("#swipebox-slider .slide").eq(s).contents().find("iframe").attr("src"), i("#swipebox-slider .slide").eq(s).contents().find("iframe").attr("src", e), s++, t.setSlide(s), t.preloadMedia(s + 1), d.settings.nextSlide && d.settings.nextSlide(s)) : !0 === d.settings.loopAtEnd ? (e = i("#swipebox-slider .slide").eq(s).contents().find("iframe").attr("src"), i("#swipebox-slider .slide").eq(s).contents().find("iframe").attr("src", e), s = 0, t.preloadMedia(s), t.setSlide(s), t.preloadMedia(s + 1), d.settings.nextSlide && d.settings.nextSlide(s)) : (i("#swipebox-overlay").addClass("rightSpring"), setTimeout(function() {
